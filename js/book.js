    ...
    books.slice(0, 15).forEach(book => {
        ...
        <div class="card h-100">
            <div class="card-body">
                ...
                <h6 class="card-text">Writer: <span class="text-success">${book.author_name ? book.author_name : ''}</span></h6>
                <h6 class="card-text">Publisher: <span class="text-success">${book.publisher ? book.publisher : ''}</span></h6>
